    ...
    <div className="mb-6 grid gap-3 rounded-md bg-white p-2 pb-3 shadow-sm md:mb-10 md:gap-10 md:p-6 md:pb-10 dark:bg-slate-800">
      {data?.map((e) => {
        return (
          ...
          >
            <div className="mb-1 flex justify-between text-sm font-medium group-hover:text-emerald-600 md:text-xl dark:group-hover:text-slate-300">
              <div>
            ...
            <div className="relative h-2 w-full cursor-pointer overflow-hidden rounded-full bg-emerald-100 group-hover:opacity-80 md:h-4">
              <span
